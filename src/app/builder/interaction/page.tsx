...
import { RotateCcw, MousePointerClick, Hand, Layers } from 'lucide-react';
    ...
    return (
        <div className="pb-20">
            ...
            <div className="mb-10 flex items-center justify-between">
                <div>
                    <h2 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>상호작용</h2>
                    <p className={`mt-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                        UI 요소의 상태별(Disabled, Hover, Pressed) 투명도를 정의하여 일관된 인터랙션 경험을 제공하세요.
                    </p>
                </div>
